...
#new 20250621
		...
		print $ARGV[$n],"\t", $ARGV[$j],"\t",$num_n,"\t",$num_n_self_diff,"\t",$num_j,"\t",$num_ctx,"\t",$diff_obj,"\t",$diff_obj_UnitN,"\t",$mut_gt2_ctx,"\t";
		if($num_ctx == 0) {
			print "0\t0\tnan\tnan\n";
		}
		else {
